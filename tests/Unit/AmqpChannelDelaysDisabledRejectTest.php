 ...
 */
class AmqpChannelDelaysDisabledRejectTest extends BaseTest
{
    protected $master;
    ...
    public function setUp(): void
    {
        ...
        $this->properties = array_merge($this->properties, [
            'queue' => 'test_delay_reject_disabled',
            ...
            'bindings' => [
                [
                    'queue'    => 'test_delay_reject_disabled',
                    'routing'  => 'example.route.delay_reject_disabled',
                ],
            ],
            'timeout' => 1,
        ]);
    ...
    public function testPublishToChannelAndConsumeDelaysRejectWithoutCaching()
    {
        ...
        $this->master->publish('example.route.delay_reject_disabled', $messages[0]);
        $this->master->publish('example.route.delay_reject_disabled', $messages[1]);
