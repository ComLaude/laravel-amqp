 ...
 */
class AmqpChannelRestartedWithPcntlSignallerTest extends BaseTest
{
    protected $master;
    ...
    public function setUp(): void
    {
        ...
        $this->properties = array_merge($this->properties, [
            'queue' => 'test_amqp_channel_persistent_restart_with_pcntl',
            ...
            'register_pcntl_heartbeat_sender' => 1,
        ]);
